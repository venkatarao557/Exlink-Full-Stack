using ExlinkAPI.Controllers.Base;
...
namespace ExlinkAPI.Controllers
{
    ...
    //    }
    //}
    // api/ApprovedCertifiers
    public class ApprovedCertifiersController : GenericController<ApprovedCertifier, ApprovedCertifierDto>
    {
        //private readonly IApprovedCertifierRepository _repository;
        public ApprovedCertifiersController(IApprovedCertifierRepository repository) : base(repository)
        {
           // _repository = repository;
        }
    }
